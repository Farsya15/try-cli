...
### Library-Specific Override (Advanced)
...
This means strings of length 0-22 are stored entirely within the struct definition. Creating them or modifying them requires zero heap interaction.</content>
<parameter name="filePath">docs/zstr_docs.md