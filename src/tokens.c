...
#line 544 "src/tokens.c"
static const int token_parser_start = 228;
static const int token_parser_first_final = 228;
static const int token_parser_error = 0;

static const int token_parser_en_main = 228;


#line 853 "src/tokens.rl"
...
#line 906 "src/tokens.rl"
    
#line 608 "src/tokens.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
#line 845 "src/tokens.rl"
	...
	goto st228;
tr320:
#line 582 "src/tokens.rl"
	{ apply_token_b(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr321:
#line 723 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[K"); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr322:
#line 724 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[J"); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr323:
#line 564 "src/tokens.rl"
	{
...
#line 845 "src/tokens.rl"
	...
	goto st228;
tr333:
#line 587 "src/tokens.rl"
	{ apply_token_h4(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr334:
#line 588 "src/tokens.rl"
	{ apply_token_h5(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr335:
#line 589 "src/tokens.rl"
	{ apply_token_h6(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr336:
#line 726 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[?25l"); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr337:
#line 583 "src/tokens.rl"
	{ apply_token_highlight(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr338:
#line 725 "src/tokens.rl"
...
#line 845 "src/tokens.rl"
	...
	goto st228;
tr346:
#line 590 "src/tokens.rl"
	{ apply_token_strong(&parser); }
#line 845 "src/tokens.rl"
	{te = p;p--;}
	goto st228;
tr347:
#line 594 "src/tokens.rl"
