...
#line 553 "src/tokens.c"
static const int token_parser_start = 242;
static const int token_parser_first_final = 242;
static const int token_parser_error = 0;

static const int token_parser_en_main = 242;


#line 887 "src/tokens.rl"
...
#line 954 "src/tokens.rl"
    
#line 639 "src/tokens.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
#line 879 "src/tokens.rl"
	...
	goto st242;
tr339:
#line 739 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[K"); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr340:
#line 740 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[J"); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr341:
#line 571 "src/tokens.rl"
	{
...
#line 879 "src/tokens.rl"
	...
	goto st242;
tr350:
#line 600 "src/tokens.rl"
	{ apply_token_h1(&parser); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr351:
#line 601 "src/tokens.rl"
	{ apply_token_h2(&parser); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr352:
#line 602 "src/tokens.rl"
	{ apply_token_h3(&parser); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr353:
#line 603 "src/tokens.rl"
	{ apply_token_h4(&parser); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr354:
#line 604 "src/tokens.rl"
...
#line 879 "src/tokens.rl"
	...
	goto st242;
tr356:
#line 742 "src/tokens.rl"
	{ emit_ansi(&parser, "\033[?25l"); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr357:
#line 599 "src/tokens.rl"
	{ apply_token_highlight(&parser); }
#line 879 "src/tokens.rl"
	{te = p;p--;}
	goto st242;
tr358:
#line 741 "src/tokens.rl"
